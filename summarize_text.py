...
def summarize_text(text, api_key, base_url, model, prompt=None):
    client = OpenAI(
        api_key=api_key,
        base_url=base_url
    )
...
def summarize_file(txt_path, output_path=None, api_key=None, base_url=None, model=None, prompt=None):
    ...
    summary = summarize_text(text, api_key, base_url, model, prompt)
